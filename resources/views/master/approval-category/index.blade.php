            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route('master.approval-category.create') }}">
                                ...
                                @foreach ($data as $key => $d)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('master.approval-category.edit', ['id' => $d->id]) }}">
                                                <button class="btn btn-primary"><i class="fa fa-pencil"></i> Edit</button>
                                            </a>
                                            <x-forms.actions.delete :url="route('master.approval-category.delete', $d->id)" :id="$d->id" />
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
